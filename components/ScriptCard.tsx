  ...
  return (
    <div className="bg-gray-900 rounded-xl border border-gray-700 overflow-hidden">
      ...
      <div className="p-5">
        ...
        {section.notes === 'continuity-timer' && (
          <div className="mt-3 flex items-start gap-2 text-amber-400/80 text-sm bg-amber-950/30 border border-amber-800/40 rounded-lg px-3 py-2">
            <Info className="w-4 h-4 flex-shrink-0 mt-0.5" />
            <span>
              Run the remainder of the net from here. Use the Check-in, Report, and Stations tab
              <span className="hidden lg:inline"> on the right</span> to switch modes. When finished,
              click the next button below this message to close the net.
            </span>
          </div>
        )}
